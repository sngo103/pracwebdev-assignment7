  ...
  render() {
    return (
      <div className="justify-center text-center">
        ...
        <Link className="w-full flex items-center justify-center  border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:text-lg" to="/pracwebdev-assignment7/home">Return to Home</Link>
      </div>
    );
  }
}
